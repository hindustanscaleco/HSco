...
class SiteUserManager(BaseUserManager):
    ...
    def create_user(self, email, mobile, first_name, last_name, password=None, dob=None, is_staff=False, is_active=True,
                    is_admin=False,):
        if not mobile:
    ...
    def create_superuser(self, email, mobile, first_name, last_name, password=None, dob=None):
    ...
    def create_staffuser(self, email, mobile, first_name, last_name, user_type, password=None, dob=None):
        user = self.create_user(
            email=email,
            mobile=mobile,
            first_name=first_name,
...
class SiteUser(AbstractBaseUser):
    ...
    user_type = models.CharField('Type Of User',max_length=20)
