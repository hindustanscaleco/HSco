...
class Feedback(models.Model):
    ...
    knowledge_of_person = models.DecimalField(default=0.0, null=True, blank=True, decimal_places=1, max_digits=18)
    timeliness_of_person = models.DecimalField(default=0.0, null=True, blank=True, decimal_places=1, max_digits=18)
    price_of_product = models.DecimalField(default=0.0, null=True, blank=True, decimal_places=1, max_digits=18)
