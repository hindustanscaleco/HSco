...
class Feedback(models.Model):
    ...
    knowledge_of_person = models.IntegerField(default=0, null=True, blank=True)
    timeliness_of_person = models.IntegerField(default=0, null=True, blank=True)
    price_of_product = models.IntegerField(default=0, null=True, blank=True)
    overall_interaction = models.IntegerField(default=0, null=True, blank=True)
