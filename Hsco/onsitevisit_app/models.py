...
class Onsite_Feedback(models.Model):
    ...
    onsite_repairing_id = models.ForeignKey(Onsite_aftersales_service, on_delete=models.CASCADE)
    backend_team = models.DecimalField(default=0.0, null=True, blank=True, decimal_places=2, max_digits=18)
    onsite_worker = models.DecimalField(default=0.0, null=True, blank=True, decimal_places=2, max_digits=18)
    speed_of_performance = models.DecimalField(default=0.0, null=True, blank=True, decimal_places=2, max_digits=18)
    price_of_reparing = models.DecimalField(default=0.0, null=True, blank=True, decimal_places=2, max_digits=18)
    overall_interaction = models.DecimalField(default=0.0, null=True, blank=True, decimal_places=2, max_digits=18)
