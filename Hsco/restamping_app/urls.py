...
from .views import restamping_after_sales_service, report_restamping, restamping_manager, restamping_product, update_restamping_details, final_report_restamping, restamping_employee_graph, update_restamping_product, restamping_analytics
