...
def final_report_restamping(request):
    ...
    with connection.cursor() as cursor:
        ...
        cursor.execute(
            "SELECT " + repair_product_string + " from restamping_app_restamping_product , restamping_app_restamping_after_sales_service where restamping_app_restamping_product.restamping_id_id = restamping_app_restamping_after_sales_service.id and restamping_app_restamping_product.entry_date between'" + restamp_start_date + "' and '" + restamp_end_date + "';")
        row = cursor.fetchall()
