...
class Amc_After_Sales(models.Model):
    ...
    visit_1 = models.CharField(max_length=80,null=True,blank=True)
    repot_1 = models.CharField(max_length=80,null=True,blank=True)
    visit_2 = models.CharField(max_length=80,null=True,blank=True)
    repot_2 = models.CharField(max_length=80,null=True,blank=True)
    visit_3 = models.CharField(max_length=80,null=True,blank=True)
    repot_3 = models.CharField(max_length=80,null=True,blank=True)
    visit_4 = models.CharField(max_length=80,null=True,blank=True)
