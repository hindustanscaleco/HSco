...
class AMC_Feedback(models.Model):
    ...
    satisfied_with_work = models.DecimalField(default=0.0, null=True, blank=True, decimal_places=2, max_digits=18)
    speed_of_performance = models.DecimalField(default=0.0, null=True, blank=True, decimal_places=2, max_digits=18)
    price_of_amc = models.DecimalField(default=0.0, null=True, blank=True, decimal_places=2, max_digits=18)
