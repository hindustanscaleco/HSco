...
def repairing_employee_graph(request,user_id):
    ...
    if speed_of_performance!= None or price_of_reparing!= None or overall_interaction!=None or satisfied_with_communication != None:
        ...
        satisfied_with_communication_avg = round(satisfied_with_communication['satisfied_with_communication__avg'])
