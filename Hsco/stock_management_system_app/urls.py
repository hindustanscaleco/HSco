...
add_product_godown,request_admin, add_product_master, product_master_list, update_product_master,stock_report, stock_godown_report
...
urlpatterns = [
    ...
    path('stock_godown_report/<int:godown_id>',stock_godown_report, name ='stock_godown_report'),
