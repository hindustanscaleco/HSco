...
def stock_godown_report(request,godown_id):
    ...
    if request.method == 'POST' or request.method == 'FILES':
        ...
        if select_type == 'Day':
            products_list = GodownProduct.objects.filter(godown_id=godown_id).order_by('product_id__scale_type__id').order_by('product_id__main_category__id')
...
def stock_report(request):
    ...
    if request.method == 'POST' or request.method == 'FILES':
        ...
        #         print(item.name)
        if select_type == 'Day':
            products_list = Product.objects.all().order_by('scale_type__id').order_by('main_category__id')
